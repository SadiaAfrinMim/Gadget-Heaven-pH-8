...
const Cardbanner = () => {
    return (
       <div className='w-11/12 mx-auto  '>
         <div className="bg-purple-600 rounded-lg shadow-lg pb-36  flex flex-col items-center">
        <h1 className="text-white text-4xl font-extrabold mb-4 text-center mt-32 ">
