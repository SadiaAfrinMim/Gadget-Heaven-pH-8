...
const CardDetails = () => {
  ...
  return (
    <div className="flex justify-center  items-center w-10/12 lg:w-8/12 mx-auto relative">
    {singleDetails ? (
      <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col lg:flex-row gap-8 justify-center items-center lg:-mt-24 -mt-20">
